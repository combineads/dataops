...
wget https://mirrors.aliyun.com/apache/incubator/druid/0.15.0-incubating/apache-druid-0.15.0-incubating-bin.tar.gz -P ./
wget https://mirrors.aliyun.com/apache/flink/flink-1.8.0/flink-1.8.0-bin-scala_2.12.tgz -P ./
wget https://mirrors.aliyun.com/apache/flume/1.9.0/apache-flume-1.9.0-bin.tar.gz -P ./
wget https://mirrors.aliyun.com/apache/hadoop/common/hadoop-3.2.0/hadoop-3.2.0.tar.gz -P ./
wget https://mirrors.aliyun.com/apache/hive/hive-3.1.1/apache-hive-3.1.1-bin.tar.gz -P ./
wget https://mirrors.aliyun.com/apache/kafka/2.3.0/kafka_2.12-2.3.0.tgz -P ./
...
wget https://mirrors.aliyun.com/apache/kylin/apache-kylin-2.6.2/apache-kylin-2.6.2-bin-hbase1x.tar.gz -P ./
...
wget https://mirrors.aliyun.com/apache/storm/apache-storm-2.0.0/apache-storm-2.0.0.tar.gz -P ./
...
wget https://repo1.maven.org/maven2/io/prestosql/presto-server/307/presto-server-307.tar.gz -P ./
...
wget http://mirrors.aliyun.com/apache/hbase/2.2.0/hbase-2.2.0-bin.tar.gz -O ./hbase-2.2.0.tar.gz
tar -zxvf hbase-2.2.0.tar.gz -C /tmp/
cd /tmp
rm -rf /tmp/hbase-2.2.0/lib/hadoop-*
tar -czvf $repo_dir_base/hbase-2.2.0.tar.gz hbase-2.2.0
cd $repo_dir_base
